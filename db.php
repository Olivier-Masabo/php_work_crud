<?php
// Shared database connection and session bootstrap
...
// Database connection settings — update as needed for your environment.
...
/**
 * Clean a string input by trimming and removing control characters.
 */
